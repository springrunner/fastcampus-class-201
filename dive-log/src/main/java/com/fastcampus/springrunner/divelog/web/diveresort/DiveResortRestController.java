...
public class DiveResortRestController {
    ...
    @WebTraceLog(apiName="다이브리조트 등록", enableRequestBody = true)
    ...
    @WebTraceLog(apiName="다이브리조트 상세조회")
    ...
    @WebTraceLog(apiName="다이브리조트 변경", enableRequestBody = true)
